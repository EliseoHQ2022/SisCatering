...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Reporte de consumo por comensal</h4>
                    ...
                    <form class="row row-cols-lg-auto g-3 align-items-center" method="POST" action="ControladorVenta">
                        ...
                        <div class="col-12">
                            <button type="submit" class="btn btn-primary" name="accion" value="consultares">Consultar</button>
                        </div>
                    </form>
                    <br>
